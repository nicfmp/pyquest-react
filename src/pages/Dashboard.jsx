...
import pytonKnightBannerBg from '../assets/python-knight-banner-bg.jpg'
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${dashboardBg})`, backgroundSize: 'auto 150%' }}
      >
        {/* véu escuro por cima da arte de fundo, só pra garantir contraste do texto */}
        <div className="absolute inset-0 bg-ink/55" />

        <main className="relative mx-auto max-w-6xl px-8 py-12">
          <div className="mb-10">
            ...
            <h1 className="mb-2 font-display text-[32px] font-bold text-paper drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]">
          ...
          <Link
            ...
            style={{ backgroundImage: `url(${pytonKnightBannerBg})`, backgroundSize: 'auto 130%' }}
          >
