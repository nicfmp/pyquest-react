...
export default function PytonKnight() {
  ...
  // Passa a base da API e o token de login para dentro do jogo (que roda em
  // um <iframe> isolado) via query string, para que o próprio jogo consiga
  // buscar e salvar o progresso no backend. Ver public/game/pyton-knight/systems/RemoteSync.js
  const gameSrc = useMemo(() => {
    ...
    return `/game/pyton-knight/index.html?${params.toString()}`
  }, [])
